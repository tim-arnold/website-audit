# Riseboro — Remediation Audit

## Project

Remediation audit for **https://riseboro.org**. The goal is to identify and prioritize issues to fix on the existing site — no rebuild is planned.

## Client

- **Name:** Riseboro
- **Public URL:** https://riseboro.org
- **Previous domain:** N/A
- **CMS:** WordPress
- **Hosting:** Pantheon
- **Local site path:** N/A
